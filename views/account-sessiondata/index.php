...
/** @var app\models\AccountSessiondataSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = Yii::t('app', 'Account Wheelchairs');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="account-wheelchair-index">
    <?= GridView::widget([
        'id' => 'user',
        ...
        'panel' => [
            ...
            'heading' => '<i class="fas fa-map-pin"></i>  Session',
//            'heading' => '<i class="fas fa-map"></i>  Session',
            'type' => 'primary',
